...
const posts = [
  { title: "The Art of Deckle Edges — Why Handmade Paper Feels Different", cat: "Craft Stories", date: "May 2025", img: "https://images.unsplash.com/photo-1455390582262-044cdead277a?auto=format&fit=crop&w=900&q=80" },
  { title: "Sanganer: The Ancient Village That Papers the World", cat: "Jaipur Heritage", date: "Apr 2025", img: "https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&w=900&q=80" },
  { title: "How to Care for Your Leather Journal — A Complete Guide", cat: "Product Care", date: "Mar 2025", img: "https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=900&q=80" },
];
