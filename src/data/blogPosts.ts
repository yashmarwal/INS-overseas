// Shared blog posts data — imported by journal.tsx and journal.$slug.tsx
export const posts = [
  {
    ...
    date: "May 2025",
    readTime: "4 min read",
    img: "/blog/deckle-edges.png",
    title: "The Art of Deckle Edges — Why Handmade Paper Feels Different",
    excerpt:
      "That soft, irregular fringe at the edge of a handmade sheet is not a flaw. It is the most honest thing about the paper. We explain how deckle edges form and why every serious paper collector prizes them.",
    content: `When you hold a sheet of our handmade cotton paper for the first time, the first thing you notice is the edge. It is not straight. It is not cut. It feathers outward in a soft, organic fringe that catches the light differently at every angle.
...
A deckle edge is fragile. That is part of what makes it precious.`,
  },
  {
    ...
    date: "Apr 2025",
    readTime: "5 min read",
    img: "/blog/sanganer-village.png",
    title: "Sanganer: The Ancient Village That Papers the World",
    excerpt:
      "Fifteen kilometres from Jaipur's old city, on the banks of the Sâmbhar river, a community has been making paper by hand for over 400 years. This is their story — and ours.",
    content: `If you have ever received a handmade paper journal from India, there is a good chance it passed through Sanganer.
...
We do not take that lightly.`,
  },
  {
    ...
    date: "Mar 2025",
    readTime: "3 min read",
    img: "/blog/leather-care.png",
    title: "How to Care for Your Leather Journal — A Complete Guide",
    excerpt:
      "Buffalo leather improves with age — but only if you treat it right. Here is everything your customers need to know about conditioning, storing, and using their INS Overseas journal.",
    content: `A well-made leather journal should last decades. The buffalo leather we use at INS Overseas is full-grain — the outermost layer of the hide, with all the natural grain intact. It is the most durable part of the leather, and it develops a patina over time that makes each journal unique.
...
That is the point.`,
  },
  {
    ...
    date: "Feb 2025",
    readTime: "4 min read",
    img: "/blog/fountain-pen-paper.png",
    title: "Choosing Paper for Fountain Pens vs Watercolour — What Actually Matters",
    excerpt:
      "Not all handmade paper is the same. The weight, surface texture, and sizing treatment all determine whether your pen glides or catches, whether your colours bleed or bloom. A practical guide.",
    content: `We get asked this question constantly by retailers sourcing for art supply shops: which of your papers works for fountain pens, and which for watercolour?
...
Fountain pen ink is water-based and flows freely. The paper needs to be sized — treated to resist liquid absorption. Unsized paper causes ink to bleed into the fibres immediately, creating feathering.

It also needs to be smooth enough to allow the nib to glide without catching. Our standard cotton rag has a natural texture that most nib sizes handle well. Very fine nibs (EF, F) perform best on our smoother pressed sheets.
...
Watercolour requires the opposite of quick absorption. Artists want the paint to stay workable on the surface long enough to blend and layer. They need weight — our 200–300 gsm cotton sheets hold water without buckling.

The natural grain of our handmade paper holds pigment in the valleys, creating the characteristic soft edge of watercolour on cotton. Our paper also contains no fluorescent whiteners. This matters for colour accuracy.
...
If you are stocking for serious artists: specify our loose sheet packs in 200+ gsm. These are designed for painting and mixed media use and will outperform anything made from wood pulp.`,
  },
  {
    ...
    date: "Jan 2025",
    readTime: "3 min read",
    img: "/blog/hand-stitched-binding.png",
    title: "Hand-Stitched Bindings: An Ancient Skill That Holds Everything Together",
    excerpt:
      "The binding is the most technically demanding part of making a journal. We use three traditional stitch methods — Coptic, long stitch, and saddle stitch. Here is what each one does and why it matters.",
    content: `You can tell a lot about a journal by looking at its spine.
